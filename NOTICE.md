...
This repository is an unofficial modified fork of [joeseesun/qiaomu-reader](https://github.com/joeseesun/qiaomu-reader). Fork-specific work is maintained at [Rosemary1812/qiaomu-reader](https://github.com/Rosemary1812/qiaomu-reader). The project name and original copyright notices are retained for attribution; the fork is not presented as an official release by the upstream maintainer.

The fork carries prominent modification notices in `README.md` and `CHANGELOG.md`. Git history records the authors and dates of individual changes. Source releases and compiled plugin assets remain under GPL-3.0-only, while third-party components retain their respective terms.
