...
- No claim that every blank-page report has the same cause; the visible user book was 世说新语, whose prior progress backup lacked a CFI; the same bundled EPUB and percentage-only record are included in QA. Physical mobile devices are not covered by this desktop test.
